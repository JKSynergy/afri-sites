...
// Package detail modal (for future enhancement)
function showPackageDetails(packageName) {
    const packageData = {
        'Kidepo Valley & Murchison Falls': {
            title: 'Kidepo Valley & Murchison Falls',
        ...
        'Uganda & Rwanda Gorilla Safari': {
            ...
            itinerary: [
                'Day 1: Arrival in Kampala/Kigali',
                'Day 2-3: Bwindi Impenetrable Forest - Gorilla trekking',
                'Day 4: Travel to Rwanda',
                'Day 5-6: Volcanoes National Park - Gorilla trekking',
                'Day 7: Cultural visit and departure'
            ]
        },
        'Uganda Big Five Safari': {
            title: 'Uganda Big Five Safari',
            duration: '5 Days / 4 Nights',
            price: 'Contact for Pricing',
            includes: [
                'Big Five tracking experiences',
            ...
            itinerary: [
                'Day 1: Arrival and Queen Elizabeth National Park',
                'Day 2: Game drives - Lion and Leopard tracking',
                'Day 3: Elephant and Buffalo encounters',
                'Day 4: Rhino tracking at Ziwa Sanctuary',
    ...
    const modalContent = `
        <div style="background: white; padding: 2rem; border-radius: 15px; max-width: 600px; max-height: 80vh; overflow-y: auto;">
            <h2 style="color: #e74c3c; margin-bottom: 1rem;">${data.title}</h2>
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 2rem;">
                <div><strong>Duration:</strong> ${data.duration}</div>
                <div><strong>Price:</strong> ${data.price}</div>
            </div>
            
            <h3 style="color: #333; margin-bottom: 1rem;">Package Includes:</h3>
            <ul style="margin-bottom: 2rem; padding-left: 1.5rem;">
                ${data.includes.map(item => `<li style="margin-bottom: 0.5rem;">${item}</li>`).join('')}
            </ul>
            
            <h3 style="color: #333; margin-bottom: 1rem;">Itinerary:</h3>
            <ul style="margin-bottom: 2rem; padding-left: 1.5rem;">
                ${data.itinerary.map(day => `<li style="margin-bottom: 0.5rem;">${day}</li>`).join('')}
            </ul>
            
            <div style="display: flex; gap: 1rem; justify-content: center;">
                <a href="tel:+256393101000" style="background: #e74c3c; color: white; padding: 0.75rem 1.5rem; border-radius: 25px; text-decoration: none; font-weight: 600;">Book Now</a>
                <a href="#contact" style="background: transparent; color: #e74c3c; border: 2px solid #e74c3c; padding: 0.75rem 1.5rem; border-radius: 25px; text-decoration: none; font-weight: 600;">Get Quote</a>
            </div>
        </div>
    `;
